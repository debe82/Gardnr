...
VALUES
    (1, 'Lipstick', 'Aeschynanthus lobianus', 'every day', '32', '14', 'Bright light',
     ...
     Provided they get adequate heat, humidity, and filtered sunlight, you can enjoy abundant blooms for much of the year. In general, however,
      lipstick plants flower most profusely in summer and autumn.','http://www.plantasonya.com.br/wp-content/img/Aeschynanthun-pulcher.jpg')
...
VALUES
    (2, 'Maindenhair', 'Adiantum raddianum', 'every day', '30', '12', 'Bright light',
     'Maidenhair ferns have delicate fan-shaped leaf segments, typically clustered on wiry black stems, and their leaves are smaller than other types of
      ...
      full mature size. Plant the fern outdoors any time during the year if you live in the right USDA zone where theyll thrive.',
    'https://s3.amazonaws.com/eit-planttoolbox-prod/media/images/Adiantum-raddianum-2--Forest-and-Kim-Starr--CC-BY.jpg') ON CONFLICT DO NOTHING;
...
VALUES
    (3, 'Silver vase', 'Aechmea fatsiata', 'every day', '30', '12', 'Bright light',
     ...
     base of the main rosette', 'https://www.plantandflowerinfo.com/images/aechmea-bromeliad-plantOG.jpg') ON CONFLICT DO NOTHING;
...
VALUES
    (4, 'Ariegated Carabbean Agave', 'Agave angustilolia Marginata', 'every week', '35', '5', '6 or more hours of direct sunlight per day',
     ...
     flowers.', 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Agave_angustifolia-_plants_near_Yagul_Oaxaca.jpg/1920px-Agave_angustifolia-_plants_near_Yagul_Oaxaca.jpg') ON CONFLICT DO NOTHING;
...
VALUES
    (5, 'Coral berry', 'Aechmea ramosa', 'every day', '30', '10', 'Bright light',
     ...
     are very sharp so take care when handling them, gloves are recommended.', 'https://cdn.pixabay.com/photo/2017/09/01/08/16/rowan-2703385_1280.jpg') ON CONFLICT DO NOTHING;
...
VALUES
    (7, 'Rosy Maidenhair', 'Adiantum hispidulum', 'every day', '30', '12', 'Bright light',
     ...
     Young growth may have a pinkish tinge before it matures into the dark green foliage.', 'https://hardyferns.org/wp-content/uploads/2018/07/Adiantum-hispidulum-RSBG-2012-Sue-o-1-78.jpg') ON CONFLICT DO NOTHING;
...
VALUES
    (8, 'Dragon tree Agave', 'Agave attenuata', 'every day', '35', '5', '6 or more hours of direct sunlight per day',
     ...
     it is popular as an ornamental plant in gardens in many other places with subtropical and warm climates',
     'https://cdn.pixabay.com/photo/2014/07/05/00/14/dragon-tree-agave-384361_1280.jpg') ON CONFLICT DO NOTHING;
...
VALUES
    (9, 'Chinese Evergreen', 'Aglaonema', 'every day', '28', '18', 'Bright light',
     ...
     of the genus are native to humid, shady tropical forest habitat, normally in South and Southeast Asia.',
     'https://cdn.pixabay.com/photo/2018/03/30/17/16/ixora-3275918_1280.jpg') ON CONFLICT DO NOTHING;
...
VALUES
    (10, 'Blue Agave', 'Agave verschaffeltii', 'every week', '35', '12', '6 or more hours of direct sunlight per day',
     ...
     fructose, in the core of the plant is the main characteristic that makes it suitable for the preparation of alcoholic beverages.',
     'https://cdn.pixabay.com/photo/2022/10/31/21/06/blue-agave-7560745_1280.jpg') ON CONFLICT DO NOTHING;
